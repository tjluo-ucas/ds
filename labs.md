...
六个实验协议分别支持 DS-A1 至 DS-A6，并与第 2、4、6、8、10、12 周的计分任务一一对应。实验页面提供方法与证据规范，不构成六次作业之外的额外计分项。
...
建议交付：源代码、可再生测试数据、运行 README、图表及简洁报告。若该实验作为对应计分任务提交，统一使用[作业页面]({{ '/assignments/' | relative_url }})公布的 5 分 Rubric，不另设第二套权重。
